        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-12 gap-4 md:gap-6">
            {products.slice(0, 4).map((product, i) => {
              const gridClasses = [
                "col-span-2 md:col-span-7 h-[45vh] md:h-[60vh]",
                "col-span-1 md:col-span-5 h-[30vh] md:h-[60vh]",
                "col-span-1 md:col-span-5 h-[35vh] md:h-[60vh] mt-8 md:mt-0",
                "col-span-2 md:col-span-7 h-[40vh] md:h-[60vh]",
              ];
              const sizeHints = [
              ...
              return (
                <Link key={product.id} href={`/products/${product.id}`} className="contents">
                  <motion.div
                    ...
                    className={`${gridClasses[i]} relative rounded-[2rem] overflow-hidden group shadow-lg cursor-pointer`}
                  >
                    <Image
                      src={product.image}
                      alt={product.alt}
                    ...
                    <div className="absolute bottom-6 left-6 md:bottom-8 md:left-8 text-white translate-y-0 md:translate-y-4 md:opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                      <p className="font-serif text-2xl md:text-3xl drop-shadow-sm">
                        {product.title}
                      </p>
                      <p className="text-xs md:text-sm/6 uppercase tracking-wider opacity-90">
                        {product.category}
                      </p>
